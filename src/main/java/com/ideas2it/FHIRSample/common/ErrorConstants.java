 ...
 */
package com.ideas2it.FHIRSample.common;
...
public class ErrorConstants {
    ...
    public static final String STREET_NAME_SHOULD_NOT_BE_NULL = "Street name should not be null";

    public static final String CITY_NAME_SHOULD_NOT_BE_NULL = "City name should not be null";
    ...
    public static final String GENDER_SHOULD_NOT_BE_NULL = "Gender should not be null";
